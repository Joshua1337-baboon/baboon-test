...
const App = () => {
    ...
    const handleEmojiClick = (index) => {
      ...
      if (index === 2) { // Если нажата кнопка с сердечком
          setShowTimer(true);
          console.log(index)
      } else {
          if(currentQuestion >= 8) {
    ...
    return (
        <div className="app">
            <div className="center">
              <Header activeButton={activeButton} setActiveButton={handleEmojiClick} gif={questions[currentQuestion].gif} index={currentQuestion} />
              {showTimer ? ( <Timer /> ) : (
                <>
